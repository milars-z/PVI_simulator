...
WORLD_CONFIG = {
    ...
    "lane": [
        {
            "id": 0,
            "bottom_x": 0.0, # 车道的左下角坐标_x,对单车道情况一般设计为(0，0)
            "bottom_y": 0.0, # 车道的左下角坐标_x,对单车道情况一般设计为(0，0)
            "width": 4.0, # 车道宽度
            "length": 80.0, # 车道长度
    ...
    "cross_road": [
        {
            "id": 0,
            "bottom_x": 60.0, #人行道的左下角坐标_x,
            "bottom_y": 0.0, #人行道的左下角坐标_y,
            "width": 2.0, #人行道宽度
    ...
    "ped_spawn": {
        ...
        "bias_y": -3.0, # 行人生成推荐点位y，相较于道路bottom的偏置值，代表行人从3m外的地方生成
